...
int find_all_max(int max, int save_all_max[][2], int weight[][5])				//max 값과 같은 값을 배열에 넣어주는 함수
{
	int cnt = 0;
...
int rand_max(int save_all_max[][2], int *Y_max, int *X_max, int cnt)			//max값중  하나를 랜덤으로 뽑아주는 함수
{
	int rand_num;
